		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section style="text-align:center;" role="main" class="content-body">
					...
					<h2 style="text-align:center;">Introduce una ueva familia</h2>
				<div style="text-align:center;">
					<table style="HEIGHT:100%;WIDTH:100%;" border=0>
						...
						<form action="" method="post">
							<td><input type="text" name="nombrefamilia" minlength="5" /></td>
						</tr>
...
if  (isset($_POST['submit'])) {
	...
	$nombrefamilia = mysqli_real_escape_string($conecta,$_POST['nombrefamilia']);
	
		 
			
			mysqli_query($conecta, "INSERT INTO Familia (nombre_familia) VALUES('".$nombrefamilia."')");
