		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section style="text-align:center;" role="main" class="content-body">
					...
					<h2 style="text-align:center;">Introduzca un nuevo lote</h2>
				<div style="text-align:center;">
					<table style="HEIGHT:100%;WIDTH:100%;" border=0>
						...
						<form action="" method="post">
							<td><input type="text" name="descripcion" minlength="5" /></td>
							<td><input type="date" name="fecha" readonly id="fechaActual">
							</td>
						</tr>
...
if  (isset($_POST['submit'])) {
	...
	$descripcion = mysqli_real_escape_string($conecta,$_POST['descripcion']);
	
		 
			
		mysqli_query($conecta, "INSERT INTO lote_articulos (descripcion) VALUES(default,curdate(),$_POST[descripcion]')");
