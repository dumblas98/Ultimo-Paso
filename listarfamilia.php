...
if (!$resultado) {
    ...
    echo mysqli_errno($conecta)."<BR>";
    echo mysqli_error($conecta)."<BR>";
    die("La sentencia de SQL ha fallado");
		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section style="text-align:center;" role="main" class="content-body">
					...
					<h2 style="text-align:center;">Lista de Familias</h2>
				<div style="text-align:center;">
					<table style="HEIGHT:100%;WIDTH:100%;" border=1>
						...
						<?php	
						$sql="select id_familia,nombre_familia from (Familia)";
						...
						<tr  align="center" bottom="middle">
							...
							<td><?php echo $mostrar['id_familia']	?></td>
							<td><?php echo $mostrar['nombre_familia']	?></td>
						</tr>
