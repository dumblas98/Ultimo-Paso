		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section style="text-align:center;" role="main" class="content-body">
					...
					<h2 style="text-align:center;">Lista Tipo de Articulos</h2>
				<div style="text-align:center;">
					<table style="HEIGHT:100%;WIDTH:100%;" border=1>
						...
						<?php	
						$sql="select id_tipo,nombre_familia,nombre from (Articulos as a,Familia as f) where a.id_familia=f.id_familia";
